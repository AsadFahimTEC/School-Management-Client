const Weather = () => {
  return (
    <div className="mt-0 bg-violet-800">
      <div className="max-w-md p-8 mx-auto rounded-lg text-white">
        <div className="flex justify-between space-x-8">
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-xl font-semibold">Kalai</h1>
          </div>
          <span className="font-bold text-8xl">14°</span>
        </div>
        <div className="flex justify-between mt-8 space-x-4 dark:text-gray-600">
